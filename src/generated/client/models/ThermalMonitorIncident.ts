...
export function ThermalMonitorIncidentFromJSONTyped(json: any, ignoreDiscriminator: boolean): ThermalMonitorIncident {
  ...
  return {
    ...
    pagedPolicies: !exists(json, "pagedPolicies")
      ? undefined
      : (json["pagedPolicies"] as Array<any>).map(ThermalMonitorIncidentPagedPolicyFromJSON),
...
export function ThermalMonitorIncidentToJSON(value?: ThermalMonitorIncident | null): any {
  ...
  return {
    ...
    pagedPolicies:
      value.pagedPolicies === undefined
        ? undefined
        : (value.pagedPolicies as Array<any>).map(ThermalMonitorIncidentPagedPolicyToJSON),
