...
export class ThermalMonitorPagingPoliciesApi extends runtime.BaseAPI {
   ...
   */
  async createPagingPolicyRaw(
    requestParameters: CreatePagingPolicyRequest,
  ): Promise<runtime.ApiResponse<ThermalMonitorPagingPolicy>> {
    if (
      requestParameters.thermalMonitorPagingPolicy === null ||
      requestParameters.thermalMonitorPagingPolicy === undefined
    ) {
      throw new runtime.RequiredError(
        "thermalMonitorPagingPolicy",
        "Required parameter requestParameters.thermalMonitorPagingPolicy was null or undefined when calling createPagingPolicy.",
      );
    }
    if (requestParameters.thermalMonitorId === null || requestParameters.thermalMonitorId === undefined) {
      throw new runtime.RequiredError(
        "thermalMonitorId",
        "Required parameter requestParameters.thermalMonitorId was null or undefined when calling createPagingPolicy.",
      );
    }
    ...
    const response = await this.request({
      path: `/monitoring/v1/thermalMonitors/{thermalMonitorId}/pagingPolicies`.replace(
        `{${"thermalMonitorId"}}`,
        encodeURIComponent(String(requestParameters.thermalMonitorId)),
      ),
      method: "POST",
   ...
   * Create paging policy
   */
  async createPagingPolicyWithHeaders(
    requestParameters: CreatePagingPolicyRequest,
  ): Promise<[ThermalMonitorPagingPolicy, Headers]> {
    const response = await this.createPagingPolicyRaw(requestParameters);
  ...
  async deletePagingPolicyRaw(requestParameters: DeletePagingPolicyRequest): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.thermalMonitorId === null || requestParameters.thermalMonitorId === undefined) {
      throw new runtime.RequiredError(
        "thermalMonitorId",
        "Required parameter requestParameters.thermalMonitorId was null or undefined when calling deletePagingPolicy.",
      );
    }
    if (requestParameters.pagingPolicyId === null || requestParameters.pagingPolicyId === undefined) {
      throw new runtime.RequiredError(
        "pagingPolicyId",
        "Required parameter requestParameters.pagingPolicyId was null or undefined when calling deletePagingPolicy.",
      );
    }
    const queryParameters: any = {};
    const headerParameters: runtime.HTTPHeaders = {};
    ...
    const response = await this.request({
      path: `/monitoring/v1/thermalMonitors/{thermalMonitorId}/pagingPolicies/{pagingPolicyId}`
        .replace(`{${"thermalMonitorId"}}`, encodeURIComponent(String(requestParameters.thermalMonitorId)))
        .replace(`{${"pagingPolicyId"}}`, encodeURIComponent(String(requestParameters.pagingPolicyId))),
      method: "DELETE",
      headers: headerParameters,
      query: queryParameters,
    });
   ...
   */
  async findPagingPolicyRaw(
    requestParameters: FindPagingPolicyRequest,
  ): Promise<runtime.ApiResponse<ThermalMonitorPagingPolicy>> {
    if (requestParameters.thermalMonitorId === null || requestParameters.thermalMonitorId === undefined) {
      throw new runtime.RequiredError(
        "thermalMonitorId",
        "Required parameter requestParameters.thermalMonitorId was null or undefined when calling findPagingPolicy.",
      );
    }
    if (requestParameters.pagingPolicyId === null || requestParameters.pagingPolicyId === undefined) {
      throw new runtime.RequiredError(
        "pagingPolicyId",
        "Required parameter requestParameters.pagingPolicyId was null or undefined when calling findPagingPolicy.",
      );
    }
    const queryParameters: any = {};
    const headerParameters: runtime.HTTPHeaders = {};
   ...
   * Find a paging policy by ID
   */
  async findPagingPolicyWithHeaders(
    requestParameters: FindPagingPolicyRequest,
  ): Promise<[ThermalMonitorPagingPolicy, Headers]> {
    const response = await this.findPagingPolicyRaw(requestParameters);
    const value = await response.value();
   ...
   */
  async listPagingPoliciesRaw(
    requestParameters: ListPagingPoliciesRequest,
  ): Promise<runtime.ApiResponse<Array<ThermalMonitorPagingPolicy>>> {
    if (requestParameters.thermalMonitorId === null || requestParameters.thermalMonitorId === undefined) {
      throw new runtime.RequiredError(
        "thermalMonitorId",
        "Required parameter requestParameters.thermalMonitorId was null or undefined when calling listPagingPolicies.",
      );
    }
    const queryParameters: any = {};
   ...
   * List paging policies
   */
  async listPagingPoliciesWithHeaders(
    requestParameters: ListPagingPoliciesRequest,
  ): Promise<[Array<ThermalMonitorPagingPolicy>, Headers]> {
    const response = await this.listPagingPoliciesRaw(requestParameters);
    const value = await response.value();
    return [value, response.raw.headers];
  }
   ...
   */
  async updatePagingPolicyRaw(
    requestParameters: UpdatePagingPolicyRequest,
  ): Promise<runtime.ApiResponse<ThermalMonitorPagingPolicy>> {
    if (
      requestParameters.thermalMonitorPagingPolicy === null ||
      requestParameters.thermalMonitorPagingPolicy === undefined
      ...
      throw new runtime.RequiredError(
        "thermalMonitorPagingPolicy",
        "Required parameter requestParameters.thermalMonitorPagingPolicy was null or undefined when calling updatePagingPolicy.",
      );
    }
    if (requestParameters.thermalMonitorId === null || requestParameters.thermalMonitorId === undefined) {
      throw new runtime.RequiredError(
        "thermalMonitorId",
        "Required parameter requestParameters.thermalMonitorId was null or undefined when calling updatePagingPolicy.",
      );
    }
    if (requestParameters.pagingPolicyId === null || requestParameters.pagingPolicyId === undefined) {
      throw new runtime.RequiredError(
        "pagingPolicyId",
        "Required parameter requestParameters.pagingPolicyId was null or undefined when calling updatePagingPolicy.",
      );
    }
    const queryParameters: any = {};
    const headerParameters: runtime.HTTPHeaders = {};
   ...
   * Update paging policy
   */
  async updatePagingPolicyWithHeaders(
    requestParameters: UpdatePagingPolicyRequest,
  ): Promise<[ThermalMonitorPagingPolicy, Headers]> {
    const response = await this.updatePagingPolicyRaw(requestParameters);
    const value = await response.value();
