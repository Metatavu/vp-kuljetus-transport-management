...
export class ThermometersApi extends runtime.BaseAPI {
   ...
   */
  async findTerminalThermometerRaw(
    requestParameters: FindTerminalThermometerRequest,
  ): Promise<runtime.ApiResponse<TerminalThermometer>> {
    if (requestParameters.thermometerId === null || requestParameters.thermometerId === undefined) {
      throw new runtime.RequiredError(
        "thermometerId",
        "Required parameter requestParameters.thermometerId was null or undefined when calling findTerminalThermometer.",
      );
    }
    ...
    const response = await this.request({
      path: `/delivery-info/v1/thermometers/{thermometerId}`.replace(
        `{${"thermometerId"}}`,
        encodeURIComponent(String(requestParameters.thermometerId)),
      ),
      method: "GET",
   ...
   * Find a terminal thermometer by ID
   */
  async findTerminalThermometerWithHeaders(
    requestParameters: FindTerminalThermometerRequest,
  ): Promise<[TerminalThermometer, Headers]> {
    const response = await this.findTerminalThermometerRaw(requestParameters);
   ...
   */
  async findTruckOrTowableThermometerRaw(
    requestParameters: FindTruckOrTowableThermometerRequest,
  ): Promise<runtime.ApiResponse<TruckOrTowableThermometer>> {
    if (requestParameters.thermometerId === null || requestParameters.thermometerId === undefined) {
      throw new runtime.RequiredError(
        "thermometerId",
        "Required parameter requestParameters.thermometerId was null or undefined when calling findTruckOrTowableThermometer.",
      );
    }
    const queryParameters: any = {};
    const headerParameters: runtime.HTTPHeaders = {};
    ...
    const response = await this.request({
      path: `/vehicle-management/v1/thermometers/{thermometerId}`.replace(
        `{${"thermometerId"}}`,
        encodeURIComponent(String(requestParameters.thermometerId)),
      ),
      method: "GET",
   ...
   * Find truck or towable thermometer by ID
   */
  async findTruckOrTowableThermometer(
    requestParameters: FindTruckOrTowableThermometerRequest,
  ): Promise<TruckOrTowableThermometer> {
   ...
   * Find truck or towable thermometer by ID
   */
  async findTruckOrTowableThermometerWithHeaders(
    requestParameters: FindTruckOrTowableThermometerRequest,
  ): Promise<[TruckOrTowableThermometer, Headers]> {
    const response = await this.findTruckOrTowableThermometerRaw(requestParameters);
    const value = await response.value();
    return [value, response.raw.headers];
  }
   ...
   */
  async listTerminalThermometersRaw(
    requestParameters: ListTerminalThermometersRequest,
  ): Promise<runtime.ApiResponse<Array<TerminalThermometer>>> {
    const queryParameters: any = {};
   ...
   * List terminal thermometers
   */
  async listTerminalThermometers(
    requestParameters: ListTerminalThermometersRequest = {},
  ): Promise<Array<TerminalThermometer>> {
   ...
   * List terminal thermometers
   */
  async listTerminalThermometersWithHeaders(
    requestParameters: ListTerminalThermometersRequest,
  ): Promise<[Array<TerminalThermometer>, Headers]> {
    const response = await this.listTerminalThermometersRaw(requestParameters);
    const value = await response.value();
    return [value, response.raw.headers];
  }
   ...
   */
  async listTruckOrTowableThermometersRaw(
    requestParameters: ListTruckOrTowableThermometersRequest,
  ): Promise<runtime.ApiResponse<Array<TruckOrTowableThermometer>>> {
    const queryParameters: any = {};
   ...
   * List truck or towable thermometers
   */
  async listTruckOrTowableThermometers(
    requestParameters: ListTruckOrTowableThermometersRequest = {},
  ): Promise<Array<TruckOrTowableThermometer>> {
   ...
   * List truck or towable thermometers
   */
  async listTruckOrTowableThermometersWithHeaders(
    requestParameters: ListTruckOrTowableThermometersRequest,
  ): Promise<[Array<TruckOrTowableThermometer>, Headers]> {
    const response = await this.listTruckOrTowableThermometersRaw(requestParameters);
    const value = await response.value();
    return [value, response.raw.headers];
  }
   ...
   */
  async updateTerminalThermometerRaw(
    requestParameters: UpdateTerminalThermometerRequest,
  ): Promise<runtime.ApiResponse<TerminalThermometer>> {
    if (
      requestParameters.updateTruckOrTowableThermometerRequest === null ||
      requestParameters.updateTruckOrTowableThermometerRequest === undefined
    ) {
      throw new runtime.RequiredError(
        "updateTruckOrTowableThermometerRequest",
        "Required parameter requestParameters.updateTruckOrTowableThermometerRequest was null or undefined when calling updateTerminalThermometer.",
      );
    }
    if (requestParameters.thermometerId === null || requestParameters.thermometerId === undefined) {
      throw new runtime.RequiredError(
        "thermometerId",
        "Required parameter requestParameters.thermometerId was null or undefined when calling updateTerminalThermometer.",
      );
    }
    const queryParameters: any = {};
    const headerParameters: runtime.HTTPHeaders = {};
   ...
   * Update terminal thermometer
   */
  async updateTerminalThermometerWithHeaders(
    requestParameters: UpdateTerminalThermometerRequest,
  ): Promise<[TerminalThermometer, Headers]> {
    const response = await this.updateTerminalThermometerRaw(requestParameters);
    const value = await response.value();
   ...
   */
  async updateTruckOrTowableThermometerRaw(
    requestParameters: UpdateTruckOrTowableThermometerOperationRequest,
  ): Promise<runtime.ApiResponse<TruckOrTowableThermometer>> {
    if (
      requestParameters.updateTruckOrTowableThermometerRequest === null ||
      requestParameters.updateTruckOrTowableThermometerRequest === undefined
      ...
      throw new runtime.RequiredError(
        "updateTruckOrTowableThermometerRequest",
        "Required parameter requestParameters.updateTruckOrTowableThermometerRequest was null or undefined when calling updateTruckOrTowableThermometer.",
      );
    }
    if (requestParameters.thermometerId === null || requestParameters.thermometerId === undefined) {
      throw new runtime.RequiredError(
        "thermometerId",
        "Required parameter requestParameters.thermometerId was null or undefined when calling updateTruckOrTowableThermometer.",
      );
    }
    const queryParameters: any = {};
    const headerParameters: runtime.HTTPHeaders = {};
   ...
   * Update truck or towable thermometer
   */
  async updateTruckOrTowableThermometer(
    requestParameters: UpdateTruckOrTowableThermometerOperationRequest,
  ): Promise<TruckOrTowableThermometer> {
   ...
   * Update truck or towable thermometer
   */
  async updateTruckOrTowableThermometerWithHeaders(
    requestParameters: UpdateTruckOrTowableThermometerOperationRequest,
  ): Promise<[TruckOrTowableThermometer, Headers]> {
    const response = await this.updateTruckOrTowableThermometerRaw(requestParameters);
    const value = await response.value();
...
export type ListTruckOrTowableThermometersEntityTypeEnum =
  (typeof ListTruckOrTowableThermometersEntityTypeEnum)[keyof typeof ListTruckOrTowableThermometersEntityTypeEnum];
