...
export class SitesApi extends runtime.BaseAPI {
  ...
  async createSiteRaw(requestParameters: CreateSiteRequest): Promise<runtime.ApiResponse<Site>> {
    if (requestParameters.site === null || requestParameters.site === undefined) {
      throw new runtime.RequiredError(
        "site",
        "Required parameter requestParameters.site was null or undefined when calling createSite.",
      );
    }
  ...
  async findSiteRaw(requestParameters: FindSiteRequest): Promise<runtime.ApiResponse<Site>> {
    if (requestParameters.siteId === null || requestParameters.siteId === undefined) {
      throw new runtime.RequiredError(
        "siteId",
        "Required parameter requestParameters.siteId was null or undefined when calling findSite.",
      );
    }
    const queryParameters: any = {};
    const headerParameters: runtime.HTTPHeaders = {};
    ...
    const response = await this.request({
      path: `/delivery-info/v1/sites/{siteId}`.replace(
        `{${"siteId"}}`,
   ...
   */
  async listSiteTemperaturesRaw(
    requestParameters: ListSiteTemperaturesRequest,
  ): Promise<runtime.ApiResponse<Array<TerminalTemperature>>> {
    if (requestParameters.siteId === null || requestParameters.siteId === undefined) {
      throw new runtime.RequiredError(
        "siteId",
        "Required parameter requestParameters.siteId was null or undefined when calling listSiteTemperatures.",
      );
    }
    const queryParameters: any = {};
    ...
    const response = await this.request({
      path: `/delivery-info/v1/sites/{siteId}/temperatures`.replace(
        `{${"siteId"}}`,
        encodeURIComponent(String(requestParameters.siteId)),
      ),
      method: "GET",
   ...
   * List temperature readings by site, including archived thermometers
   */
  async listSiteTemperaturesWithHeaders(
    requestParameters: ListSiteTemperaturesRequest,
  ): Promise<[Array<TerminalTemperature>, Headers]> {
    const response = await this.listSiteTemperaturesRaw(requestParameters);
    const value = await response.value();
    return [value, response.raw.headers];
  }
  ...
  async updateSiteRaw(requestParameters: UpdateSiteRequest): Promise<runtime.ApiResponse<Site>> {
    if (requestParameters.site === null || requestParameters.site === undefined) {
      throw new runtime.RequiredError(
        "site",
        "Required parameter requestParameters.site was null or undefined when calling updateSite.",
      );
    }
    if (requestParameters.siteId === null || requestParameters.siteId === undefined) {
      throw new runtime.RequiredError(
        "siteId",
        "Required parameter requestParameters.siteId was null or undefined when calling updateSite.",
      );
    }
    const queryParameters: any = {};
    const headerParameters: runtime.HTTPHeaders = {};
