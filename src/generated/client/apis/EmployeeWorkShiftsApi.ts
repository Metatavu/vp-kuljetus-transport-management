...
import { EmployeeWorkShift, EmployeeWorkShiftFromJSON, EmployeeWorkShiftToJSON } from "../models";
...
export class EmployeeWorkShiftsApi extends runtime.BaseAPI {
   ...
   */
  async createEmployeeWorkShiftRaw(
    requestParameters: CreateEmployeeWorkShiftRequest,
  ): Promise<runtime.ApiResponse<EmployeeWorkShift>> {
    if (requestParameters.employeeWorkShift === null || requestParameters.employeeWorkShift === undefined) {
      throw new runtime.RequiredError(
        "employeeWorkShift",
        "Required parameter requestParameters.employeeWorkShift was null or undefined when calling createEmployeeWorkShift.",
      );
    }
    if (requestParameters.employeeId === null || requestParameters.employeeId === undefined) {
      throw new runtime.RequiredError(
        "employeeId",
        "Required parameter requestParameters.employeeId was null or undefined when calling createEmployeeWorkShift.",
      );
    }
    ...
    const response = await this.request({
      path: `/user-management/v1/employees/{employeeId}/workShifts`.replace(
        `{${"employeeId"}}`,
   ...
   * Create Employee Work Shift.
   */
  async createEmployeeWorkShiftWithHeaders(
    requestParameters: CreateEmployeeWorkShiftRequest,
  ): Promise<[EmployeeWorkShift, Headers]> {
    const response = await this.createEmployeeWorkShiftRaw(requestParameters);
   ...
   */
  async deleteEmployeeWorkShiftRaw(
    requestParameters: DeleteEmployeeWorkShiftRequest,
  ): Promise<runtime.ApiResponse<void>> {
    if (requestParameters.employeeId === null || requestParameters.employeeId === undefined) {
      throw new runtime.RequiredError(
        "employeeId",
        "Required parameter requestParameters.employeeId was null or undefined when calling deleteEmployeeWorkShift.",
      );
    }
    if (requestParameters.workShiftId === null || requestParameters.workShiftId === undefined) {
      throw new runtime.RequiredError(
        "workShiftId",
        "Required parameter requestParameters.workShiftId was null or undefined when calling deleteEmployeeWorkShift.",
      );
    }
    const queryParameters: any = {};
    const headerParameters: runtime.HTTPHeaders = {};
    ...
    const response = await this.request({
      path: `/user-management/v1/employees/{employeeId}/workShifts/{workShiftId}`
        .replace(`{${"employeeId"}}`, encodeURIComponent(String(requestParameters.employeeId)))
        .replace(`{${"workShiftId"}}`, encodeURIComponent(String(requestParameters.workShiftId))),
      method: "DELETE",
      headers: headerParameters,
      query: queryParameters,
    });
   ...
   */
  async findEmployeeWorkShiftRaw(
    requestParameters: FindEmployeeWorkShiftRequest,
  ): Promise<runtime.ApiResponse<EmployeeWorkShift>> {
    if (requestParameters.employeeId === null || requestParameters.employeeId === undefined) {
      throw new runtime.RequiredError(
        "employeeId",
        "Required parameter requestParameters.employeeId was null or undefined when calling findEmployeeWorkShift.",
      );
    }
    if (requestParameters.workShiftId === null || requestParameters.workShiftId === undefined) {
      throw new runtime.RequiredError(
        "workShiftId",
        "Required parameter requestParameters.workShiftId was null or undefined when calling findEmployeeWorkShift.",
      );
    }
    const queryParameters: any = {};
    const headerParameters: runtime.HTTPHeaders = {};
   ...
   * Find Employee Work Shift.
   */
  async findEmployeeWorkShiftWithHeaders(
    requestParameters: FindEmployeeWorkShiftRequest,
  ): Promise<[EmployeeWorkShift, Headers]> {
    const response = await this.findEmployeeWorkShiftRaw(requestParameters);
    const value = await response.value();
   ...
   */
  async listEmployeeWorkShiftsRaw(
    requestParameters: ListEmployeeWorkShiftsRequest,
  ): Promise<runtime.ApiResponse<Array<EmployeeWorkShift>>> {
    if (requestParameters.employeeId === null || requestParameters.employeeId === undefined) {
      throw new runtime.RequiredError(
        "employeeId",
        "Required parameter requestParameters.employeeId was null or undefined when calling listEmployeeWorkShifts.",
      );
    }
    const queryParameters: any = {};
   ...
   * List Employees Work Shifts.
   */
  async listEmployeeWorkShiftsWithHeaders(
    requestParameters: ListEmployeeWorkShiftsRequest,
  ): Promise<[Array<EmployeeWorkShift>, Headers]> {
    const response = await this.listEmployeeWorkShiftsRaw(requestParameters);
    const value = await response.value();
    return [value, response.raw.headers];
  }
   ...
   */
  async updateEmployeeWorkShiftRaw(
    requestParameters: UpdateEmployeeWorkShiftRequest,
  ): Promise<runtime.ApiResponse<EmployeeWorkShift>> {
    if (requestParameters.employeeWorkShift === null || requestParameters.employeeWorkShift === undefined) {
      throw new runtime.RequiredError(
        "employeeWorkShift",
        "Required parameter requestParameters.employeeWorkShift was null or undefined when calling updateEmployeeWorkShift.",
      );
    }
    if (requestParameters.employeeId === null || requestParameters.employeeId === undefined) {
      throw new runtime.RequiredError(
        "employeeId",
        "Required parameter requestParameters.employeeId was null or undefined when calling updateEmployeeWorkShift.",
      );
    }
    if (requestParameters.workShiftId === null || requestParameters.workShiftId === undefined) {
      throw new runtime.RequiredError(
        "workShiftId",
        "Required parameter requestParameters.workShiftId was null or undefined when calling updateEmployeeWorkShift.",
      );
    }
    const queryParameters: any = {};
    const headerParameters: runtime.HTTPHeaders = {};
   ...
   * Update Employee Work Shift.
   */
  async updateEmployeeWorkShiftWithHeaders(
    requestParameters: UpdateEmployeeWorkShiftRequest,
  ): Promise<[EmployeeWorkShift, Headers]> {
    const response = await this.updateEmployeeWorkShiftRaw(requestParameters);
    const value = await response.value();
