...
function AggregationsTableForOffice({ employee, employeeAggregatedHours }: Props) {
    ...
    <Table>
      <TableBody>
        ...
        <TableRow>
          ...
          <TableCell align="right">
            <Typography variant="h6">{`${employeeAggregatedHours?.fillingHours.toFixed(2)} h`}</Typography>
          </TableCell>
        </TableRow>
      </TableBody>
    </Table>
